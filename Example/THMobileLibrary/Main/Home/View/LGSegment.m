...
-(void)commonInit {
    //按钮名称
    NSMutableArray *titleList = [[NSMutableArray alloc]initWithObjects:@"本馆新闻",@"系统公告", nil];
...
- (void)createItem:(NSMutableArray *)item {
    ...
    for (int i = 0; i<count; i++) {
        ...
        UIButton *buttonItem = [[UIButton alloc] initWithFrame:CGRectMake(buttonX-20, 0, 100, self.frame.size.height)];
        //设置
        buttonItem.tag = i + 1;
...
-(void)buttonClick:(id)sender {
    ...
    NSLog(@"11111111111111111%ld",btn.tag);
