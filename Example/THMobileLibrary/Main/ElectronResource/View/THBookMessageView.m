...
//    CGFloat height;
    CGFloat opinX=10;
    //图书图片
    _bookImage  = [[UIImageView alloc] initWithFrame:CGRectMake(10, opinX, 100,130)];
    [self addSubview:_bookImage];
    //书名
    _bookName = [[UILabel alloc] initWithFrame:CGRectMake(_bookImage.frame.size.width+20, opinX,frame.size.width-_bookImage.frame.size.width-20, 20)];
...
//    作者
    _bookAuthor = [[UILabel alloc] initWithFrame:CGRectMake(_bookImage.frame.size.width+20,opinX+30 ,frame.size.width-_bookImage.frame.size.width-20, 15)];
...
//    出版社
    _press = [[UILabel alloc] initWithFrame:CGRectMake(_bookImage.frame.size.width+20,opinX+50 ,frame.size.width-_bookImage.frame.size.width-20, 15)];
...
//    ISBN
    ...
    _isbn = [[UILabel alloc] initWithFrame:CGRectMake(_bookImage.frame.size.width+20,opinX+70 ,frame.size.width-_bookImage.frame.size.width-20, 15)];
...
//    文件格式
    _fileExt = [[UILabel alloc] initWithFrame:CGRectMake(_bookImage.frame.size.width+20,opinX+90 ,frame.size.width-_bookImage.frame.size.width-20, 15)];
