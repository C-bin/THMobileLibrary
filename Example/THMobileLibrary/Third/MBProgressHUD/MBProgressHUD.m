...
#pragma mark bigebn 源代码 [label.text sizeWithFont:label.font];
	CGSize labelSize = [label.text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17]}];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
   ...
   CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font } context:NULL].size;
